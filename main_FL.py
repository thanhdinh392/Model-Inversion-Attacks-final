...
if __name__ == "__main__":
    ...
    if args.iid:
        if args.noise:
            if args.sigma == 0.001:
                print("Noise min, sigma = 0.001")
                base_dir = f"./noise_gauss_min/{args.dataset}/log_main_iid"
            if args.sigma == 0.01:
                print("Noise max, sigma = 0.01")
                base_dir = f"./noise_gauss_max/{args.dataset}/log_main_iid"
        else:
        ...
        #     if args.sigma == 0.001:
        #         print("Noise min, sigma = 0.001")
        #         base_dir = f"./noise_gauss_min/{args.dataset}/log_main_non_iid"
        #     if args.sigma == 0.01:
        #         print("Noise max, sigma = 0.01")
        #         base_dir = f"./noise_gauss_max/{args.dataset}/log_main_non_iid"
        # else:
    ...
    if args.iid:
        li = [1, 10, 50, 100]  # list specific epoch iid
    else:
        li = [1, 10, 50, 100]  # list specific epoch non-iid
    # training epochs
